...
@router.get("/", response_model=List[ModeloRelatorio], include_in_schema=False)
...
@router.post("/", response_model=ModeloRelatorio, status_code=status.HTTP_201_CREATED, include_in_schema=False)
